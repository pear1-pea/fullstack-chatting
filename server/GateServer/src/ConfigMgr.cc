...
ConfigMgr::ConfigMgr(const ConfigMgr &src) { _config_map = src._config_map; }
...
ConfigMgr::ConfigMgr() {
  ...
  // construct the full path of the config.ini file
  boost::filesystem::path config_pat = current_path / "config.ini";
