...
public:
  ...
  explicit PROTOBUF_CONSTEXPR
      GetVarifyRsp(::google::protobuf::internal::ConstantInitialized);
...
public:
  ...
  template <typename = void>
  explicit PROTOBUF_CONSTEXPR
      GetVarifyReq(::google::protobuf::internal::ConstantInitialized);
...
GetVarifyReq::email() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline std::string *
GetVarifyReq::mutable_email() ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline const std::string &
GetVarifyRsp::email() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline std::string *
GetVarifyRsp::mutable_email() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string *_s = _internal_mutable_email();
...
inline const std::string &
GetVarifyRsp::code() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
