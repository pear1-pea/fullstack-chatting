...
public:
  ...
  public:
    ...
    std::unique_ptr<
        ::grpc::ClientAsyncResponseReaderInterface<::message::GetVarifyRsp>>
  ...
  public:
    WithAsyncMethod_GetVarifyCode() { ::grpc::Service::MarkMethodAsync(0); }
    ~WithAsyncMethod_GetVarifyCode() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status
    GetVarifyCode(::grpc::ServerContext * /*context*/,
                  const ::message::GetVarifyReq * /*request*/,
                  ::message::GetVarifyRsp * /*response*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestGetVarifyCode(
        ::grpc::ServerContext *context, ::message::GetVarifyReq *request,
  ...
  public:
    WithCallbackMethod_GetVarifyCode() {
      ::grpc::Service::MarkMethodCallback(
          0,
          new ::grpc::internal::CallbackUnaryHandler<::message::GetVarifyReq,
                                                     ::message::GetVarifyRsp>(
    ...
    void SetMessageAllocatorFor_GetVarifyCode(
        ::grpc::MessageAllocator<::message::GetVarifyReq,
                                 ::message::GetVarifyRsp> *allocator) {
      ::grpc::internal::MethodHandler *const handler =
          ::grpc::Service::GetHandler(0);
      static_cast<::grpc::internal::CallbackUnaryHandler<
          ::message::GetVarifyReq, ::message::GetVarifyRsp> *>(handler)
    ...
    GetVarifyCode(::grpc::CallbackServerContext * /*context*/,
                  const ::message::GetVarifyReq * /*request*/,
                  ::message::GetVarifyRsp * /*response*/) {
      return nullptr;
    }
  ...
  public:
    WithGenericMethod_GetVarifyCode() { ::grpc::Service::MarkMethodGeneric(0); }
  ...
  public:
    WithRawMethod_GetVarifyCode() { ::grpc::Service::MarkMethodRaw(0); }
  ...
  public:
    WithStreamedUnaryMethod_GetVarifyCode() {
      ::grpc::Service::MarkMethodStreamed(
          0,
          new ::grpc::internal::StreamedUnaryHandler<::message::GetVarifyReq,
                                                     ::message::GetVarifyRsp>(
              [this](::grpc::ServerContext *context,
                     ::grpc::ServerUnaryStreamer<::message::GetVarifyReq,
                                                 ::message::GetVarifyRsp>
                         *streamer) {
    ...
    virtual ::grpc::Status
    StreamedGetVarifyCode(::grpc::ServerContext *context,
                          ::grpc::ServerUnaryStreamer<::message::GetVarifyReq,
                                                      ::message::GetVarifyRsp>
